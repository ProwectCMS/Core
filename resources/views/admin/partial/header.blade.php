    ...
    <nav class="navbar navbar-light">
        <div class="navbar-left">
            <a href="" class="sidebar-toggle">
                <img class="svg" src="{{ asset('vendor/prowectcms/img/admin/strikingdash/svg/bars.svg') }}" alt="img">
            </a>
            <a class="navbar-brand" href="#">
                <img src="{{ asset('vendor/prowectcms/img/prowectcms-logo-small.png') }}" alt="" height="45px">
                <span class="text-muted" style="position: relative; top: 2px">Prowect<span class="color-primary">CMS</span></span>
            </a>
        ...
        <div class="navbar-right">
            <ul class="navbar-right__menu">
                ...
                <li class="nav-author">
                    <div class="dropdown-custom">
                        <a href="javascript:;" class="nav-item-toggle">
                            <img src="{{ asset('vendor/prowectcms/img/admin/strikingdash/svg/author-more.png') }}" alt="" class="rounded-circle"></a>
                        <div class="dropdown-wrapper">
                            <div class="nav-author__info">
                                <div class="author-img">
                                    <img src="{{ asset('vendor/prowectcms/img/admin/strikingdash/svg/author-more.png') }}" alt="" class="rounded-circle">
                                </div>
                                <div>
                                    <h6>Current User</h6>
